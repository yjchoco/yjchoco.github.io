...
After a few minutes, you can enter your static website using web browsers (https://{username}.github.io)

### Step 3. Upload new post

In your repository, `_posts` directory will exist.

In `_posts` directory, make a new file named '*date*-title.md'.

Copy this text into markdown file.

And add, commit, push it!

After a few minutes, new posts will be uploaded into your website
